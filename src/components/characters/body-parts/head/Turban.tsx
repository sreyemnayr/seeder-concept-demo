...
const Turban: React.FC<HumaaanBodyPartProps> = ({ skinColor = "#B28B67", secondaryColor = "#5C63AB" }) => {
  ...
  return (
    ...
    >
      ...
      <g id="Turban" transform="translate(31.000000, 23.000000)">
        <mask id="mask-2" fill="white">
          <use xlinkHref="#path-1" />
        </mask>
        <use fill={validSecondaryColor} xlinkHref="#path-1" />
        <path
